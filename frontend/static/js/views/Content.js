...
export default class extends AbstractView {
    ...
    <section class="hero view container-small">
        <h1 class="hero-title">Manger un steak</h1>
        <div class="hero-wrapperParagraph">
            <p class="hero-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam eu turpis molestie,
        ...
        <div class="hero-wrapperData">
            <a class="hero-data--count">1 393 044 153 KG</a>
            <p class="hero-data--text">de viande consommée en France depuis le 1er janvier 2022</p>
        </div>
    </section>
    ...
    <svg class="scale-4--illustration---svg">
        <path class="scale-4--illustration---path"
                  d="M6.82677 456.232L8.36717 451.492L7.27926 430.692L5.944 386.629L6.83417 271.796L6.38909 165.866L6.01229 23.2851L8.36717 6.85357L8.72265 4.48372L12.9884 2.29161L19.5055 1.28442L28.2147 1.52141L35.265 3.2988L37.0423 5.07618L37.2793 7.32754L38.6732 63.204L37.9903 194.351L37.5452 310.519L37.9903 395.531V424.016L37.6348 433.459L37.2793 442.902L41.6635 439.939H43.1447L44.1519 442.131L43.8557 445.153L42.6115 446.575L37.2793 450.248L37.4571 452.677L39.0567 457.595L42.1968 461.979V463.164L41.1303 463.815L34.4948 464.052L28.5109 465.652L26.852 466.896L25.8448 468.437L23.4157 468.97L20.6904 468.437L19.7424 466.482L18.439 465.652L15.0027 465.178L10.8555 463.815H3.03501L2.3833 462.512L3.21275 461.209L6.82677 456.232Z"
                  fill="#C52D48" fill-opacity="0.4"/>
                  </svg>
        <div class="scale-4--container">
            <div class="scale-4--category">
                <h3 class="scale-4--Number">73%</h3>
                <img class="scale-4--illustration" src="/static/image/tree_agriculture.svg">
                <p class="scale-4--description">agriculture</p>
            </div>
            <div class="scale-4--category">
                <h3 class="scale-4--Number">10%</h3>
                <img class="scale-4--illustration" src="/static/image/tree_expension.svg">

                <p class="scale-4--description">expansion urbaine</p>
            </div>
            <div class="scale-4--category">
                <h3 class="scale-4--Number">10%</h3>
                <img class="scale-4--illustration" src="/static/image/tree_urbaine.svg">

                <p class="scale-4--description">expansion urbaine</p>
            </div>
            <div class="scale-4--category">
                <h3 class="scale-4--Number">7%</h3>
                <img class="scale-4--illustration" src="/static/image/tree_minière.svg">
    ...
    <section class="solutionIntroduction view">
        <h2>Lorem ipsum</h2>
    </section>
    <section class="solutionFirst view" id="solutionFirst">
        <h2>Lorem ipsum</h2>
    </section>
    <section class="solutionSecond view" id="solutionSecond">
        <h2>Lorem ipsum</h2>
    </section>
